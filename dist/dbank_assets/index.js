...
/*!***************************************!*\
  ...
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/dbank */ "./src/declarations/dbank/index.js");

window.addEventListener("load", async function() {
    //console.log("Finished loading");
    // update();
    
    const currentValue= await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.checkBalance();
    this.document.getElementById("value").innerText=Math.round(currentValue*100)/100;
...
document.querySelector("form").addEventListener("submit",async function(event){
    ...
    if (document.getElementById("input-amount").value.length!=0){
        await _declarations_dbank__WEBPACK_IMPORTED_MODULE_0__.dbank.topUp(amountTopUp);//top up the amount
    }
